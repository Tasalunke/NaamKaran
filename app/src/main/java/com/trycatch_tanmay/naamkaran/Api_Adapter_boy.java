...
public class Api_Adapter_boy extends RecyclerView.Adapter<Api_Adapter_boy.ViewHolder> {
    private Context context;
    private ArrayList<Api_POJO> pojoboys;
    private OnItemClickListener listener;

    public Api_Adapter_boy(Context context, ArrayList<Api_POJO> pojoboys) {
        this.context = context;
        this.pojoboys = pojoboys;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Api_POJO pojo = pojoboys.get(position);
        if (pojo != null && pojo.getName() != null) {
            holder.boyName.setText("Name: " + pojo.getName());
        } else {
            holder.boyName.setText("Name: N/A"); // Set a default value or handle null case as per your requirement
        }
        holder.boyName.setText("Name: " + pojo.getName());
        ...
        holder.heart_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isFavorite) {
                    ...
                    Toast.makeText(context, "Name and Meaning copied to clipboard and added to Wishlist", Toast.LENGTH_SHORT).show();
                }
