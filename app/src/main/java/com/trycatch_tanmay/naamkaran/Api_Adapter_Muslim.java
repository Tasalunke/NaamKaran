...
public class Api_Adapter_Muslim extends RecyclerView.Adapter<Api_Adapter_Muslim.ViewHolder> {
    private Context context;
    private ArrayList<Api_POJO_Muslim> pojoMuslims;


    public Api_Adapter_Muslim(Context context, ArrayList<Api_POJO_Muslim> pojoMuslims) {
        this.context = context;
        this.pojoMuslims = pojoMuslims;
    }


    @NonNull
    @Override
    public Api_Adapter_Muslim.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.boy_itemview, parent, false);
        return new Api_Adapter_Muslim.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Api_Adapter_Muslim.ViewHolder holder, int position) {
        Api_POJO_Muslim pojo = pojoMuslims.get(position);
